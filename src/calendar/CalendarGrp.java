...
public class CalendarGrp<C extends Calendar> {

	protected ArrayList<C> _calendars = new ArrayList<C>();
	protected DateTime _start, _end;
	
	public CalendarGrp(DateTime start, DateTime end){
		_start = start;
		_end = end;
	}
	
	public CalendarGrp(DateTime start, DateTime end, Collection<C> cals){
		_start = start;
		_end = end;
